...
class sketch_from_svg:
    ...
    def draw(self, retain=True):
        ...
        self.pen = tu.Turtle()
        self.pen.speed(0)
        self.pen.hideturtle()  # Hides the turtle cursor
        tu.tracer(0, 0)  # Turns off animation
        ...
        tu.update()  # Updates the turtle graphics screen

        if retain:
            tu.done()

pen = sketch_from_svg('ali.svg', scale=80)
pen.draw()
